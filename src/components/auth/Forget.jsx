...
<div className=' flex flex-col justify-between  bg-[#4FD1C5] w-full md:w-[40%] h-auto md:h-full sm:rounded-l-3xl'>
    ...
    <div className='flex relative justify-end gap-3 m-3'>
       <div className='flex gap-7'>
       <select className=" relative block appearance-none bg-transparent text-white px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline-blue focus:border-black-300">
